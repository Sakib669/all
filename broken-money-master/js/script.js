const calculateExpense = () => {
  ...
  // calculate expense
  const expense =
    parseInt(food) + parseFloat(rent) + parseFloat(clothes);
  // calculate balance
...
const calculateSavings = () => {
  ...
  const savePercentageFloat = parseFloat(savePercentage);
//   Validate saving percentage value
  ...
  const savingAmount = parseFloat(income) * savePercentageFloat / 100;
